...
⚠️ DEPRECATION NOTICE (2025-10-04):
   Questo file è stato SOSTITUITO da tempo_adjust_learn_helper.py

   AGGIORNAMENTI:
   - Mappature corrette con analisi TSI
   - deck_c_tempo_adjust: CC 2 (non CC 42)
   - deck_d_tempo_adjust: CC 3 (non CC 43)
   - Naming corretto: "tempo_adjust" invece di "pitch"

   UTILIZZARE: tempo_adjust_learn_helper.py
