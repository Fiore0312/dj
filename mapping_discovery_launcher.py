    ...
    def __init__(self):
        ...
        self.tools = {
            ...
            'sync_cue': {
                ...
                'scripts': ['sync_cue_learn_helper.py'],
            ...
            'validation': {
                ...
                'scripts': [
                    'fx_automated_validation.py',
                    'test_fx_units_validation.py',
                    'fx_command_tester.py'
                ],
        ...
        self.quick_scripts = {
            'essential': [
                'sync_cue_learn_helper.py',
                'pitch_learn_helper.py'
            ],
            'complete': [
                'sync_cue_learn_helper.py',
                'pitch_learn_helper.py',
                'loop_learn_helper.py'
            ],
            'fx_complete': [
                'complete_fx_learn_helper.py'
            ],
