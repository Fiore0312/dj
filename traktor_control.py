...
class TraktorController:
    ...
    MIDI_MAP = {
        ...
        'deck_a_hotcue_2': (MIDIChannel.AI_CONTROL.value, 2),  # 🔄 TO TEST
        'deck_a_hotcue_3': (MIDIChannel.AI_CONTROL.value, 3),  # 🔄 TO TEST
        'deck_a_hotcue_4': (MIDIChannel.AI_CONTROL.value, 4),  # 🔄 TO TEST
